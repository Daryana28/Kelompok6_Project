...
class AreaMasukScreen extends StatefulWidget {
  const AreaMasukScreen({super.key});

  @override
  _AreaMasukScreenState createState() => _AreaMasukScreenState();
}

class _AreaMasukScreenState extends State<AreaMasukScreen> {
  void _navigateToFullScreen() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const FullScreenCameraView(),
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Image.asset(
                  'images/camera.png', // Ganti dengan path asset gambar lokasi
                  width: 50,
                  height: 50,
                ),
...
class FullScreenCameraView extends StatefulWidget {
  ...
  @override
  _FullScreenCameraViewState createState() => _FullScreenCameraViewState();
}
